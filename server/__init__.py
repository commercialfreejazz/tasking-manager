...
from flask import Flask, session, render_template, current_app, send_from_directory, abort
...
def create_app(env=None):
    ...
    def id_editor():
        ...
        context = {
            ...
            "consumer_secret": current_app.config["OSM_OAUTH_SETTINGS"]["consumer_secret"],
