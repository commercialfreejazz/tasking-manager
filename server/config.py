...
class EnvironmentConfig:
    ...
    ML_ENABLER_BUILDING_API_ENDPOINT = os.getenv(
        "TM_ML_ENABLER_BUILDING_API_ENDPOINT",
        "http://buildingfootprintsapi.azurewebsites.net/api/BuildingFootprints",
    )
    ML_ENABLER_LOOKING_GLASS_ENDPOINT = os.getenv(
        "TM_ML_ENABLER_LOOKING_GLASS_ENDPOINT", "http://localhost:8501/v1/"
    )
    ...
    ML_TILE_URL = os.getenv(
        "TM_ML_ENABLER_TILE_URL",
        "https://api.mapbox.com/v4/mapbox.streets/{z}/{x}/{y}.jpg?access_token={token}",
    )
    ML_OVERPASS_URL = os.getenv(
        "TM_ML_ENABLER_OVERPASS_URL", "https://lz4.overpass-api.de/api/interpreter"
    )
